...
problem_group = 'LASSO';
idx_scs      = costdata.data(strcmp(costdata.textdata(2:end,1),problem_group) & costdata.data(:,11)==0);
idx_superscs = costdata.data(strcmp(costdata.textdata(2:end,1),problem_group) & costdata.data(:,11)==1 ...
